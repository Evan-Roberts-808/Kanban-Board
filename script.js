...
function getSavedColumns() {
  if (localStorage.getItem('backlogItems')) {
    ...
    backlogListArray = ['Add new items by clicking Add Item button'];
    progressListArray = ['Remove items by clicking text to edit and deleting text'];
    completeListArray = ['Drag tasks by click and dragging on item'];
    onHoldListArray = [];
  }
}
